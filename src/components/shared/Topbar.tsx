...
export function TopBar() {
  return (
    <header className="h-16 bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700 flex items-center justify-between px-6 sticky top-0 z-50">
      ...
      <div className="flex items-center">
        <div className="flex gap-1 items-center justify-between h-10 rounded-full md:rounded-[8px] max-sm:p-1 p-2 md:w-[300px] border border-gray-200 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors duration-200">
          <Image
